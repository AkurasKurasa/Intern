      ...
      children: [
        ...
        },
        {
          ...
          children: [
            ...
            { id: "dead-widgets", title: "Stubborn cases: long dropdowns + paste-reject spins", status: "partial",
              note: "MECHANICS probe-verified 2026-07-11 (scratch/probe_dead_widgets.py drives the real _act_on_element): PASS spin ''→'3' (UIA ValuePattern; RangeValue added), PASS 'State' ''→'Texas' (below-fold item; winner = FIRST-LETTER CYCLING with read-back — wx.Choice matches single chars, typing 'Texas' landed on 'South Carolina'). LIVE RUN then exposed the gap the user predicted: the CLICK-FILL combobox path (and reveal-focus path) had no rescue wired — 'Texas' failed 2× and skipped. All THREE combobox paths now route into the identity-executor ladder + spin dead-mark rescue. DO: retest live on a FRESH form (probe left '3'/'Texas' behind): --start_record 2 --records 1 --start_tab 1, expect 'via identity executor rescue'." },
          ],
        },
        {
          id: "model-drives",
